          ...
          <div className="flex flex-col sm:w-1/2 md:w-1/4 lg:w-1/4 xl:w-1/4 ms-80">
            <div className="flex width m-1 ms-8 flex-shrink-0 bg-transparent box2 rounded-lg">
              <div className="flex flex-col w-full ">
                ...
                <div className="flex items-center justify-between p-4  bg-opacity-70 w-full">
                    ...
                    <div className="flex-1">
                        <input className="w-80 h-10 bg-zinc-800 px-4 py-2 rounded-lg border-none cursor-pointer text-white" type="search" name="search" placeholder="Search for Songs" onChange={handleSearch}/>
                    </div>
            ...
            <div className="text-sm text-white tracking-wide">
              ...
              <p>{song.Artist}</p>
                  ...
                  <div className="flex gap-3 mt-4 text-white text-2xl font-9 font-bold">
                  <div className="w-1/5 h-44 bg-pink-700 py-4 px-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Hindi</h4>
        <img
            src="/image/hot1.jpg"
            alt="Image"
            style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft: '55px', transform: 'rotate(24deg)' }}
        />
    </div>
    <div className="w-1/5 bg-pink-400 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Tamil</h4>
        <img
            src="/image/hot2.jpg"
            alt="Image"
            style={{ width: '100px', height: '100px', bottom: '-9px', marginLeft: '55px', transform: 'rotate(24deg)' }}
        />
    </div>
    <div className="w-1/5 bg-sky-900 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Korea</h4><img
    src="/image/hot6.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    </div>
    <div className="w-1/5 bg-blue-700 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Punjabi</h4><img
    src="/image/hot4.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    </div>
    <div className="w-1/5 bg-green-700 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Malayalam</h4><img
    src="/image/hot5.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
...
<div className="flex gap-3 mt-4 text-white text-2xl font-9 font-bold">
    <div className="w-1/5 h-44 bg-pink-900 py-4 px-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Koreantracks</h4>
        <img
    src="/image/tr1.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    ...
    <div className="w-1/5 bg-teal-800 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">OST</h4>
        <img
    src="/image/tr2.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    ...
    <div className="w-1/5 bg-violet-900 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Telugu</h4>
        <img
    src="/image/tr4.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    ...
    <div className="w-1/5 bg-blue-800 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Best K-Pop</h4>
        <img
    src="/image/tr5.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    ...
    <div className="w-1/5 bg-cyan-700 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Malayalam90s</h4>
        <img
    src="/image/tr8.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
...
<div className="flex gap-3 mt-4 text-white text-2xl font-9 font-bold">
    <div className="w-1/5 h-44 bg-yellow-800 py-4 px-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">K-club Party</h4>
        <img
    src="/image/sa1.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    ...
    <div className="w-1/5 bg-emerald-900 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Karoake</h4>
        <img
    src="/image/sa2.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    ...
    <div className="w-1/5 bg-pink-900 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Pop</h4>
        <img
    src="/image/sa3.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    ...
    <div className="w-1/5 bg-zinc-700 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Indie</h4>
        <img
    src="/image/sa4.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    ...
    <div className="w-1/5 bg-red-900 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Party</h4>
        <img
    src="/image/sa9.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
...
<div className="flex gap-3 mt-4 text-white text-2xl font-9 font-bold">
    <div className="w-1/5 h-44 bg-lime-950 py-4 px-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">BTS</h4>
        <img
    src="/image/l1.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    ...
    <div className="w-1/5 bg-cyan-600 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Top Track</h4>
        <img
    src="/image/l2.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    ...
    <div className="w-1/5 bg-orange-700 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">KimBops</h4>
        <img
    src="/image/l3.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    ...
    <div className="w-1/5 bg-fuchsia-900 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">K-Pop Fresh</h4>
        <img
    src="/image/l6.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
/>
    ...
    <div className="w-1/5 bg-rose-900 py-4 p-4 rounded-lg flex flex-col justify-between">
        <h4 className="mt-0">Work Out</h4>
        <img
    src="/image/l7.jpg"
    alt="Image"
    style={{ width: '100px', height: '100px', bottom: '-5px', marginLeft:'55px', transform: 'rotate(24deg)' }}
