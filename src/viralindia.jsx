...
export default function ViralIndia(){
    const songs = [
        { id: 1, Title: ' Bling-Bang-Bang-Born', Artist: 'Creepy Nuts ' , Album : 'Bling-Bang-Bang-Born', Duration : "2:48 " , Day : '1 days ago ' , img : 'https://i.scdn.co/image/ab67616d0000b2733f6de9c0ca2148edf20daa6b ' , music : '/music/chart features/Bling-Bang-Bang-Born.mp3 '},
                        ...
                        <div className="flex width m-1 ms-8 flex-shrink-0 bg-transparent box2 rounded-lg">
                            <div className="flex flex-col w-full ">
                                ...
                                <div  style={{ overflowY: 'auto', maxHeight: '495px', marginBlockEnd: "5px" }}>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-yellow-600 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-yellow-600 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/top6.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">Viral 5- India</p></div>
                                                <div><p className="text-white font-medium">Kick back to the best 50 track from India...</p></div>
                                     ...
                                     <div className="flex flex-col bg-yellow-600 bg-opacity-40 p-10">
