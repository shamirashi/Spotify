...
export default function HotUSA(){
    const songs = [
                        ...
                        <div className="flex width m-1 ms-8 flex-shrink-0 bg-transparent box2 rounded-lg">
                            <div className="flex flex-col w-full ">
                                ...
                                <div  style={{ overflowY: 'auto', maxHeight: '500px', marginBlockEnd: "5px" }}>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-amber-700 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-amber-700 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/hot3.jpg" alt="lofi beats" className="rounded-lg" /></div>
                                          ...
                                          <div>
                                            <div className="flex flex-col ">
                                                ...
                                                <div><p className="text-white font-medium">Just lean back and enjoy pop hits.</p></div>
                                                <div className="mt-4 flex flex-row">
                                                  ...
                                                  <div><p className="text-white font-semibold mt-2">. 1,91,102 likes . 5 songs, 10 min 27 sec</p></div>
                                                  </div>
                                            </div>
                                          </div>
                                        </div>
                                     ...
                                     <div className="flex flex-col bg-amber-700 bg-opacity-40 p-10">
