...
export default function Throw3(){
    const songs = [
        { id: 1, Title: 'Niluvaddham', Artist: 'Karthik, Sumangaly ' , Album : 'Nuvvostanante Neno ', Duration : "5:57 " , Day : ' 1 day ago' , img : 'https://i.scdn.co/image/ab67616d0000b273a1c5f8cd4b935de87d965d29  ' , music : '/music/throwback/Niluvaddham.mp3 '},
        { id: 2, Title: 'Apudo Ipudo', Artist: 'Siddharth ' , Album : 'Bommarilly ', Duration : " 4:03" , Day : ' 1 days ago' , img : ' https://i.scdn.co/image/ab67616d0000b273ae015832f67d72c805ee9d3f ' , music : ' /music/throwback/Apudo Ipudo Full Song With Telugu Lyrics II Siddharth, Genelia II Bommarillu Songs.mp3 '},
        { id: 3, Title: 'Neelo Jaerige', Artist: ' Hariharan, Shreya Ghoshal' , Album : ' Balu', Duration : "5:55 " , Day : '1 days ago ' , img : ' https://c.saavncdn.com/293/Balu-ABCDEFG-Telugu-2004-500x500.jpg' , music : '/music/throwback/Balu ABCDEFG Songs _ Neelo Jarige -  Hariharan, Shreya Ghoshal.mp3 '},
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-green-700 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-green-700 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/tr4.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">Love Songs Telugu </p></div>
                                                <div><p className="text-white font-medium">What's a better combination than... </p></div>
