...
export default function Sing5(){
    const songs = [
        { id: 1, Title: 'Stand By Me', Artist: ' Ben E.King' , Album : ' Dont Play that song', Duration : "3:00 " , Day : ' 1 day ago' , img : ' https://i.scdn.co/image/ab67616d0000b2731813ea8f590a0aab2820f922 ' , music : '/music/kpop/Ben E. King - Stand By Me (1961).mp3 '},
        { id: 2, Title: 'Oh, Pretty Woman', Artist: 'Roy Orbison ' , Album : 'The Essential Roy Orbison ', Duration : " 2:56" , Day : ' 1 days ago' , img : ' https://i.ytimg.com/vi/3KFvoDDs0XM/maxresdefault.jpg' , music : ' /music/kpop/Oh, Pretty Woman.mp3 '},
        { id: 3, Title: 'Hey Lover', Artist: ' The Daughters of Eve' , Album : 'Hey Lover ', Duration : "2:24 " , Day : '1 days ago ' , img : ' https://i.scdn.co/image/ab67616d0000b273c148a2f0d30a396bc2cc359f ' , music : '/music/kpop/Hey Lover.mp3 '},
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-green-700 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-green-700 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/sa6.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">Classic Oldies</p></div>
                                                <div><p className="text-white font-medium">Classic hits from the 50s and 60s.</p></div>
