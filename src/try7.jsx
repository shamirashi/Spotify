...
export default function Try7(){
    const songs = [
        { id: 1, Title: 'Only Girl (In The World)', Artist: 'Rihanna ' , Album : 'Loud ', Duration : "3:56" , Day : ' 1 day ago' , img : ' https://i.ytimg.com/vi/Xv9023cub0Y/maxresdefault.jpg ' , music : '/music/kpop/Rihanna - Only Girl (In The World).mp3 '},
        { id: 2, Title: 'Slumber Party ft. Tinashe', Artist: ' Britney Spears, Tinesha' , Album : ' Glory', Duration : " 3:33" , Day : ' 1 days ago' , img : 'https://i.scdn.co/image/ab67616d0000b27349ddc55a9be6ca8b6b63182c  ' , music : ' /music/kpop/Britney Spears - Slumber Party ft. Tinashe (Bad Royale Remix) (Official Audio).mp3 '},
        { id: 3, Title: 'Bitch Better Have My Money ', Artist: 'Rihanna ' , Album : 'Bitch Better Have My Money  ', Duration : "3:39 " , Day : '1 days ago ' , img : ' https://resources.tidal.com/images/6874c5b2/e22c/445c/87b7/bd4f1454f5d2/640x640.jpg' , music : '/music/kpop/Rihanna - Bitch Better Have My Money (Explicit).mp3 '},
        { id: 4, Title: 'Fancy', Artist: ' Iggy Azalea, Charli XCX ' , Album : 'The New Classic ', Duration : " 3:19" , Day : '1 days ago ' , img : 'https://upload.wikimedia.org/wikipedia/en/thumb/9/94/Iggy_Azalea_-_Fancy.png/220px-Iggy_Azalea_-_Fancy.png ' , music : '/music/kpop/Iggy Azalea - Fancy ft. Charli XCX.mp3  '},
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-green-700 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-green-700 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/l7.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">Work Out</p></div>
                                                <div><p className="text-white font-medium">Work out to music? Count me in</p></div>
