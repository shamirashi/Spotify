...
export default function Throw4(){
    const songs = [
      { id: 1, Title: 'I say "I Love You" again ', Artist: 'Kim Dong Ryul ' , Album : 'Homecoming ', Duration : "4:47 " , Day : ' 1 day ago' , img : 'https://i.scdn.co/image/ab67616d00001e023528c5455f276ac377d9c5d5  ' , music : '/music/throwback/김동률 - 다시 사랑한다 말할까 - KBS 20111209 방송 [하루한곡].mp3 '},
      { id: 2, Title: '내가 너의 곁에 잠시 살았다는 걸 ', Artist: 'Kim Yeon Woo ' , Album : '토이2집-YOUHEEYEOL ', Duration : " 5:12" , Day : ' 1 days ago' , img : ' https://i.scdn.co/image/ab67616d0000b27332030efef25be4d2e9d36498' , music : ' /music/throwback/Kim Yeon-woo - That I was once by your side, 김연우 - 내가 너의 곁에 잠시 살았다는.mp3 '},
      { id: 3, Title: '이밤이지나면  ', Artist: 'Lim Jae Beum ' , Album : '임재범 1집', Duration : " 4:10" , Day : '1 days ago ' , img : ' https://i.scdn.co/image/ab67616d00001e02c490067c9269a81239e42dcb ' , music : '/music/throwback/임재범, 전설의 무대 _이밤이 지나면_.mp3  '},
      { id: 3, Title: '점 점  ', Artist: 'Brown Eyes ' , Album : 'Reason 4 breathing? ', Duration : "3:31 " , Day : '1 days ago ' , img : 'https://image.bugsm.co.kr/album/images/500/239/23956.jpg ' , music : '/music/throwback/브라운 아이즈 -　점점.mp3 '},
                        ...
                        <div className="flex width m-1 ms-8 flex-shrink-0 bg-transparent box2 rounded-lg">
                            <div className="flex flex-col w-full ">
                                ...
                                <div  style={{ overflowY: 'auto', maxHeight: '495px', marginBlockEnd: "5px" }}>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-amber-950 bg-opacity-80 w-full">
                                     ...
                                     <div className="flex flex-col bg-amber-950 bg-opacity-80">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/tr3.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">Korean Old Vinyls</p></div>
                                                <div><p className="text-white font-medium">Listen koreas classic & old song from 70's.</p></div>
                                                <div className="mt-4 flex flex-row">
                                                  ...
                                                  <div><p className="text-white font-semibold mt-2">. 5,191,102 likes . 4 songs, 6 min 27 sec</p></div>
                                                  </div>
                                            </div>
                                          </div>
                                        </div>
                                     ...
                                     <div className="flex flex-col bg-amber-950 bg-opacity-40 p-10">
