...
export default function Try3(){
    const songs = [
        { id: 1, Title: 'Dont Go Insane', Artist: 'DPR IAN ' , Album : ' Dont Go Insane', Duration : "3:24 " , Day : ' 1 day ago' , img : ' https://images.genius.com/7aed33163499cd42d5ef068e72d32021.1000x1000x1.png ' , music : '/music/kpop/DPR IAN - Dont Go Insane (Official Music Video) _ Dear Insanity....mp3 '},
        { id: 2, Title: 'DIE 4 YOU', Artist: 'DEAN ' , Album : 'DIE 4 YOU ', Duration : " 3:14" , Day : ' 1 days ago' , img : ' https://upload.wikimedia.org/wikipedia/en/f/f5/Dean_-_Die_4_You.jpg ' , music : ' /music/kpop/DEAN - DIE 4 YOU.mp3 '},
        { id: 3, Title: 'Eve, Psyche & The Bluebeards Wife', Artist: 'LE SSERAFIM ' , Album : 'UNFORGIVEN ', Duration : "3:05 " , Day : '1 days ago ' , img : 'https://image.bugsm.co.kr/album/images/500/40859/4085992.jpg ' , music : '/music/kpop/LE SSERAFIM (르세라핌) ‘이브, 프시케 그리고 푸른 수염의 아내’ OFFICIAL M-V.mp3 '},
        { id: 4, Title: ' Perfect Night', Artist: 'LE SSERAFIM ' , Album : 'Perfect Night ', Duration : " 2:42" , Day : ' 1 days ago' , img : ' https://i.scdn.co/image/ab67616d0000b2735e352f6eccf8cb96d0b247cc ' , music : ' /music/hotkorea/lesserafim.mp3 '},
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-green-700 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-green-700 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/l3.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">KimBops!</p></div>
                                                <div><p className="text-white font-medium">rolling with the 'bops' in your Kimbap.</p></div>
