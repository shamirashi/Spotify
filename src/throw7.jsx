...
export default function Throw7(){
    const songs = [
        { id: 1, Title: 'Boy With Luv', Artist: ' BTS, Halsey' , Album : 'MAP OD SOUL: PERSONA ', Duration : "3:49 " , Day : ' 1 day ago' , img : ' https://images.genius.com/1f33fe65273ba317dad49537a4d1092e.841x841x1.png ' , music : '/music/throwback/boy with luv.mp3 '},
        ...
        { id: 3, Title: 'Lover', Artist: 'Taylor Swift ' , Album : 'Lover ', Duration : "3:41 " , Day : '1 days ago ' , img : ' https://upload.wikimedia.org/wikipedia/en/c/cd/Taylor_Swift_-_Lover.png' , music : '/music/throwback/Taylor Swift - Lover (Official Music Video).mp3 '},
        { id: 4, Title: 'YOUTH', Artist: ' Yroye Sivan' , Album : 'Blue Neighbourhood ', Duration : " 3:05" , Day : '1 days ago ' , img : 'https://i.scdn.co/image/ab67616d0000b2731a104e8630a97b573201f655 ' , music : '/music/throwback/Troye Sivan - YOUTH (Official Video).mp3  '},
        { id: 5, Title: ' Perfect', Artist: 'One Direction ' , Album : ' Made in the A.M ', Duration : " 3:50" , Day : '1 days ago ' , img : 'https://i.scdn.co/image/ab67616d0000b273241e4fe75732c9c4b49b94c3  ' , music : '/music/throwback/One Direction - Perfect (Official Video).mp3  '},
                        ...
                        <div className="flex width m-1 ms-8 flex-shrink-0 bg-transparent box2 rounded-lg">
                            <div className="flex flex-col w-full ">
                                ...
                                <div  style={{ overflowY: 'auto', maxHeight: '495px', marginBlockEnd: "5px" }}>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-fuchsia-800 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-fuchsia-800 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/tr7.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">All Out 0f 2010s</p></div>
                                                <div><p className="text-white font-medium">The biggest songs of the 2010s.</p></div>
                                     ...
                                     <div className="flex flex-col bg-fuchsia-800 bg-opacity-40 p-10">
