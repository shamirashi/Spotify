                                    ...
                                    <div className="flex items-center justify-between p-4 bg-red-800 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-red-800 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/sa3.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">Pops Favourite</p></div>
                                                <div><p className="text-white font-medium">The hits you just can't get enough of.</p></div>
