                        ...
                        <div className="flex width m-1 ms-8 flex-shrink-0 bg-transparent box2 rounded-lg">
                            <div className="flex flex-col w-full ">
                                ...
                                <div  style={{ overflowY: 'auto', maxHeight: '495px', marginBlockEnd: "5px" }}>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-indigo-900 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-indigo-900 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/l1.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">This Is BTS</p></div>
                                                <div><p className="text-white font-medium">Ten years of BTS and beyond..</p></div>
                                                <div className="mt-4 flex flex-row">
                                                  ...
                                                  <div><p className="text-white font-semibold mt-2">. 5,191,102,89 likes . 6 songs, 6 min 27 sec</p></div>
                                                  </div>
                                            </div>
                                          </div>
                                        </div>
                                     ...
                                     <div className="flex flex-col bg-indigo-900 bg-opacity-40 p-10">
