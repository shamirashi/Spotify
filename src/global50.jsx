                        ...
                        <div className="flex width m-1 ms-8 flex-shrink-0 bg-transparent box2 rounded-lg">
                            <div className="flex flex-col w-full ">
                                ...
                                <div  style={{ overflowY: 'auto', maxHeight: '495px', marginBlockEnd: "5px" }}>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-teal-800 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-teal-800 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/top3.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">Top-50 Global</p></div>
                                                <div><p className="text-white font-medium">Just lean back and enjoy 50 global hits.</p></div>
                                     ...
                                     <div className="flex flex-col bg-teal-800 bg-opacity-40 p-10">
