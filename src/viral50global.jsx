...
export default function ViralGlobal(){
    const songs = [
        { id: 1, Title: 'Praise jah In The Moonlight', Artist: 'YG Marley ' , Album : 'Praise jah In The Moonlight ', Duration : "4:23 " , Day : ' 1 day ago' , img : 'https://i1.sndcdn.com/artworks-B7hco7AnKZDVju9J-tTGg2A-t500x500.jpg  ' , music : '/music/chart features/YG Marley - _Praise Jah in the Moonlight_.mp3 '},
        { id: 2, Title: ' Poison', Artist: 'Blake Roman, Sam Haft ' , Album : 'Poison ', Duration : " 2:07" , Day : ' 1 days ago' , img : 'https://is1-ssl.mzstatic.com/image/thumb/Music126/v4/80/f3/72/80f372ca-5611-447f-b926-4ae3b42caf21/37990.jpg/1200x1200bb.jpg  ' , music : ' /music/chart features/Blake Roman - Poison (Hazbin Hotel Original Soundtrack).mp3 '},
        { id: 3, Title: ' Bling-Bang-Bang-Born', Artist: 'Crrepy Nuts ' , Album : 'Bling-Bang-Bang-Born', Duration : "2:48 " , Day : '1 days ago ' , img : 'https://i.scdn.co/image/ab67616d0000b2733f6de9c0ca2148edf20daa6b ' , music : '/music/chart features/Bling-Bang-Bang-Born.mp3 '},
        { id: 4, Title: 'CLEARED-Remix', Artist: 'Lilithzplug ' , Album : 'Meet the Lilithz ', Duration : " 2:06" , Day : '1 days ago ' , img : ' https://i.ytimg.com/vi/4dFIwZLPoi8/maxresdefault.jpg' , music : '/music/chart features/CLEARED - remix (Official Audio).mp3 '},
        { id: 5, Title: 'Murder On The Dancefloor ', Artist: 'SoBextor ' , Album : ' Read My Lips ', Duration : "3:50" , Day : '1 days ago ' , img : ' https://lastfm.freetls.fastly.net/i/u/ar0/e657aee4d46a5c7f02bea08052fe9e4c.jpg ' , music : '/music/chart features/Sophie Ellis-Bextor - Murder On The Dancefloor (as featured in Saltburn).mp3 '},
                        ...
                        <div className="flex width m-1 ms-8 flex-shrink-0 bg-transparent box2 rounded-lg">
                            <div className="flex flex-col w-full ">
                                ...
                                <div  style={{ overflowY: 'auto', maxHeight: '495px', marginBlockEnd: "5px" }}>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-green-500 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-green-500 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/top5.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">Viral 50 Global</p></div>
                                                <div><p className="text-white font-medium">Enjoy and relax with viral song globally..</p></div>
                                     ...
                                     <div className="flex flex-col bg-green-500 bg-opacity-40 p-10">
