...
export default function Try5(){
    const songs = [
        { id: 1, Title: '3D(ft. Jack Harlow)', Artist: 'Jung kook, Jack Harlow ' , Album : ' 3D(ft. Jack Harlow)', Duration : " 3:50" , Day : '1 days ago ' , img : 'https://upload.wikimedia.org/wikipedia/commons/1/1d/Jungkook_-_3D.png ' , music : '/music/hotkorea/3D.mp3 '},
        { id: 2, Title: 'Run BTS', Artist: 'BTS ' , Album : 'Proof ', Duration : "3:29 " , Day : ' 1 day ago' , img : ' https://i.pinimg.com/736x/46/e2/ae/46e2ae36684cb7d1ae2f8ff1fdfd52b9.jpg ' , music : '/music/kpop/Run Bts.mp3 '},
        { id: 3, Title: 'Boy With Luv', Artist: ' BTS, Halsey' , Album : 'MAP OD SOUL: PERSONA ', Duration : "3:49 " , Day : ' 1 day ago' , img : ' https://images.genius.com/1f33fe65273ba317dad49537a4d1092e.841x841x1.png ' , music : '/music/throwback/boy with luv.mp3 '},
        { id: 4, Title: 'Yes or No', Artist: 'Jung Kook ' , Album : ' GOLDEN', Duration : " 2:27" , Day : '1 days ago ' , img : 'https://is1-ssl.mzstatic.com/image/thumb/Music126/v4/f2/54/08/f254081d-c7e2-6cd6-f7c5-dedb56fd95bd/196922710582_Cover.jpg/1200x1200bb.jpg ' , music : '/music/kpop/Yes or No.mp3  '},
        { id: 5, Title: ' Still With You', Artist: 'Jung Kook ' , Album : 'Still With You  ', Duration : " 3:59" , Day : '1 days ago ' , img : 'https://i.scdn.co/image/ab67616d0000b273a7f42c375578df426b37638d  ' , music : '/music/kpop/Still With You.mp3  '},
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-green-700 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-green-700 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/l8.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">K-Pop for PK</p></div>
                                                <div><p className="text-white font-medium">Pakistans favourite K-pop track...</p></div>
