...
export default function Throw8(){
    const songs = [
        { id: 1, Title: 'Sreeragamo', Artist: 'K J Yesudas ' , Album : ' Suaparnika', Duration : "4:36 " , Day : ' 1 day ago' , img : 'https://c.saavncdn.com/512/Sauparnika-Malayalam-2001-20200912175026-500x500.jpg  ' , music : '/music/throwback/Sreeraagamo Thedunnu _ 1080p _ Pavithram _ Mohanlal _ Shobana _ Innocent _ Thilakan _ Sreevidhya.mp3 '},
        { id: 2, Title: 'Varuvanillrumee', Artist: 'K S Chithra ' , Album : ' Manichitrathazhu', Duration : " 4:22" , Day : ' 1 days ago' , img : ' https://i1.sndcdn.com/artworks-cEmXdVFnYK2g-0-t500x500.jpg ' , music : ' /music/throwback/Varuvanillarumee _ 1080p _ Manichithrathazhu _ Shobana _ Suresh Gopi _ Sreedhar.mp3 '},
        { id: 3, Title: 'Allimalar Kavilu', Artist: ' M G Radhakrishnan, M G Sreekumar' , Album : 'Midhunam ', Duration : "4:20 " , Day : '1 days ago ' , img : 'https://i.scdn.co/image/ab67616d0000b27385f537b6e8246eda15f5c83c ' , music : '/music/throwback/Allimalar Kaavil _ Midhunam _ M G Radhakrishnan _ MG Sreekumar _ High _ Quality Remastered.mp3 '},
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-green-700 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-green-700 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/tr8.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">All Out 0f 90s</p></div>
                                                <div><p className="text-white font-medium">Enjoy music with 90s vibe...</p></div>
