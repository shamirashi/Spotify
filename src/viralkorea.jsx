...
export default function ViralKorea(){
    const songs = [
        ...
        { id: 3, Title: 'Super Shy', Artist: 'New Jeans ' , Album : 'Super Shy ', Duration : "3:20" , Day : '1 days ago ' , img : ' https://i1.sndcdn.com/artworks-R6hzNa01DLfylgDq-Xi90EA-t500x500.jpg' , music : '/music/chart features/NewJeans (뉴진스).mp3 '},
        { id: 4, Title: ' Love Wins All', Artist: ' IU' , Album : 'Love Wins All ', Duration : " 5:23" , Day : '1 days ago ' , img : 'https://i.ytimg.com/vi/ZqJ7bfgacSA/maxresdefault.jpg ' , music : '/music/chart features/IU.mp3  '},
        { id: 5, Title: 'wherever u r ', Artist: 'UMI, V ' , Album : ' wherever u r ', Duration : " 2:36" , Day : '1 days ago ' , img : 'https://i.ytimg.com/vi/lsX6Qemv6Ik/sddefault.jpg  ' , music : '/music/chart features/UMI, V - wherever u r (ft. V of BTS) official lyric video.mp3  '},
      ];
                        ...
                        <div className="flex width m-1 ms-8 flex-shrink-0 bg-transparent box2 rounded-lg">
                            <div className="flex flex-col w-full ">
                                ...
                                <div  style={{ overflowY: 'auto', maxHeight: '495px', marginBlockEnd: "5px" }}>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-red-500 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-red-500 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/top7.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">Viral 50 Korea</p></div>
                                                <div><p className="text-white font-medium">Update of the most<br /> played 50 track.</p></div>
                                     ...
                                     <div className="flex flex-col bg-red-500 bg-opacity-40 p-10">
