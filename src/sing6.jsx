...
export default function Sing6(){
    const songs = [
        { id: 1, Title: 'Tu Felta De Querer', Artist: 'Mon Laferte ' , Album : 'Mon Laferte (Vol.1) ', Duration : "4:36 " , Day : ' 1 day ago' , img : ' https://i.scdn.co/image/ab67616d0000b2735eebf3f8ec6e9807105f3151 ' , music : '/music/kpop/Mon Laferte - Tu Falta De Querer (Video Oficial).mp3 '},
        { id: 2, Title: 'MI EX TENIA RAZON', Artist: 'KAROL G ' , Album : 'MANANA SERA BONITO ', Duration : " 2:34" , Day : ' 1 days ago' , img : ' https://images.genius.com/d21b477eda810a8a8adb22fa1caafe20.1000x1000x1.png ' , music : ' /music/kpop/KAROL G - MI EX TENÍA RAZÓN (Official Video).mp3 '},
        { id: 3, Title: 'No Se Va', Artist: ' Morat' , Album : 'Baias Pardides ', Duration : "3:36 " , Day : '1 days ago ' , img : 'https://i1.sndcdn.com/artworks-FtOEubDuyatXxLdj-8SAX0A-t500x500.jpg ' , music : '/music/kpop/Morat - No Se Va.mp3 '},
        { id: 4, Title: 'Ojos Marrones', Artist: 'Lasso ' , Album : ' Ojos Marrones', Duration : " 3:26" , Day : '1 days ago ' , img : ' https://i.scdn.co/image/ab67616d0000b273c6fbbdf9c172f4f68a89198a' , music : '/music/kpop/Lasso - Ojos Marrones (Video Oficial) Parte 1.mp3  '},
                        ...
                        <div className="flex width m-1 ms-8 flex-shrink-0 bg-transparent box2 rounded-lg">
                            <div className="flex flex-col w-full ">
                                ...
                                <div  style={{ overflowY: 'auto', maxHeight: '495px', marginBlockEnd: "5px" }}>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-sky-400 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-sky-400 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/sa7.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">Karaoke en Español</p></div>
                                                <div><p className="text-white font-medium">Saca la estrella que Ilevas dentro,</p></div>
                                     ...
                                     <div className="flex flex-col bg-sky-400 bg-opacity-40 p-10">
