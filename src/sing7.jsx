...
export default function Sing7(){
    const songs = [
        { id: 1, Title: ' Wake Me Up', Artist: 'Avicil ' , Album : 'True ', Duration : "4:07 " , Day : ' 1 day ago' , img : ' https://i.scdn.co/image/ab67616d0000b273e14f11f796cef9f9a82691a7 ' , music : '/music/kpop/Avicii - Wake Me Up (Official Video).mp3 '},
        { id: 2, Title: ' All Around The World (La La La)', Artist: 'R3HAB, A Touch Of Class ' , Album : ' All Around The World (La La La)', Duration : " 2:27" , Day : ' 1 days ago' , img : 'https://images.genius.com/03a39a6e11e0c9706a0ab0b2fc991370.1000x1000x1.jpg  ' , music : ' /music/kpop/R3HAB x A Touch Of Class - All Around The World (La La La) (Official Video).mp3 '},
        { id: 3, Title: ' Moonlight Shadow', Artist: 'Mike Oldfield ' , Album : 'Mike Oldfield Collection', Duration : "3:38 " , Day : '1 days ago ' , img : 'https://i.ytimg.com/vi/ydb_dfvn-D8/maxresdefault.jpg ' , music : '/music/kpop/Mike Oldfield ft. Maggie Reilly - Moonlight Shadow (Official Video).mp3 '},
        { id: 4, Title: 'Dance The Night (From Barbie The Album)', Artist: ' Dua Lipa' , Album : ' Dance The Night (From Barbie The Album)', Duration : " 3:33" , Day : '1 days ago ' , img : ' https://i1.sndcdn.com/artworks-AUDbjqze1ZME-0-t500x500.jpg' , music : '/music/kpop/Dua Lipa - Dance The Night (From Barbie The Album) [Official Music Video].mp3  '},
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-green-700 bg-opacity-70 w-full">
                                     ...
                                     <div className="flex flex-col bg-green-700 bg-opacity-70">
                                        <div className="flex flex-row">
                                          <div className="p-5"> <img src="/image/sa9.jpg" alt="lofi beats" className="rounded-lg" /></div>

                                          <div>
                                            <div className="flex flex-col ">
                                                <div><p className="text-white text-sm font-medium">Playlist</p></div>
                                                <div><p className="text-white text-7xl font-extrabold font-9">Party Deluxe</p></div>
                                                <div><p className="text-white font-medium">Hits zum Tanzen und Mitsingen - von...</p></div>
